...
function* tickSaga() {
  ...
  switch (node.nodeType) {
    ...
    case "IndexAccess":
      ...
      const indexValue = indexAssignment ? decode(node.indexExpression, indexAssignment) : utils.toBigNumber(node.indexExpression.hexValue);
