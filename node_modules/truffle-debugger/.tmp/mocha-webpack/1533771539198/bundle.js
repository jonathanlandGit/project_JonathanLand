 ...
 */
function allocateDeclarations(declarations, refs, slot = 0, index = WORD_SIZE - 1) {
...
function allocateValue(slot, index, bytes) {
  let from = index - bytes + 1 >= 0 ? { slot, index: index - bytes + 1 } : {
    slot: {
      path: slot.path,
...
var _decode = __webpack_require__(62);
...
var _changeCase = __webpack_require__(83);
...
var _reduxSaga = __webpack_require__(58);

var _reduxSaga2 = _interopRequireDefault(_reduxSaga);

var _reduxCliLogger = __webpack_require__(59);
...
var _sagas = __webpack_require__(61);

var ast = _interopRequireWildcard(_sagas);

var _sagas2 = __webpack_require__(66);

var controller = _interopRequireWildcard(_sagas2);

var _sagas3 = __webpack_require__(68);

var solidity = _interopRequireWildcard(_sagas3);

var _sagas4 = __webpack_require__(69);
...
var _sagas7 = __webpack_require__(70);
...
var _memory = __webpack_require__(63);

var memory = _interopRequireWildcard(_memory);

var _storage = __webpack_require__(64);
...
function decodeMemoryReference(definition, pointer, info) {
  ...
  switch (utils.typeClass(definition)) {
    ...
    case "struct":
      ...
      return (0, _assign2.default)({}, ...(variables || []).map(({ name, id }, i) => {
  ...
  switch (utils.typeClass(definition)) {
    case "array":
      ...
      return [...Array(length).keys()].map(i => {
        let childFrom = {
          slot: {
            path: from.slot.path instanceof Array ? from.slot.path : [from.slot],
            offset: offset(i)
          },
          index: index(i)
        };
    ...
    case "struct":
      ...
      const referencedDeclaration = definition.typeName ? definition.typeName.referencedDeclaration : definition.referencedDeclaration;
      ...
      return (0, _assign2.default)({}, ...(0, _entries2.default)(allocation.children).map(([id, childPointer]) => ({
...
function readRange(storage, range) {
  ...
  if (length) {
    to = {
      slot: {
        path: from.slot.path,
        offset: from.slot.offset + Math.floor((from.index + length - 1) / _utils.WORD_SIZE)
      },
  ...
  for (let i = 0; i < totalWords; i++) {
    ...
    data.set(read(storage, (0, _extends3.default)({}, from.slot, { offset })), i * _utils.WORD_SIZE);
  }
  debug("words %o", data);
...
var _reducers3 = __webpack_require__(75);

var _reducers4 = _interopRequireDefault(_reducers3);

var _reducers5 = __webpack_require__(77);

var _reducers6 = _interopRequireDefault(_reducers5);

var _reducers7 = __webpack_require__(78);
...
var _faker = __webpack_require__(82);
