...
function decodeStorageReference(definition, pointer, state, ...args) {
  ...
  switch (utils.typeClass(definition)) {
    ...
    case "struct":
      ...
      debug("child pointers %O", pointer.storage.children);
      debug("refs %O", refs);
