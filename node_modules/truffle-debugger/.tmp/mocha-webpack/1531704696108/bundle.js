...
function* tickSaga() {
  ...
  switch (node.nodeType) {
    ...
    case "IndexAccess":
      ...
      // value appears to be available in `node.indexExpression.value`
      ...
      const indexValue = indexAssignment ? decode(node.indexExpression, indexAssignment) : utils.typeClass(node.indexExpression) == "stringliteral" && decode(node.indexExpression, {
        "literal": node.indexExpression.value
      });
