...
function* tickSaga() {
  ...
  switch (node.nodeType) {
    ...
    case "IndexAccess":
      ...
      const indexValue = indexAssignment ? decode(node.indexExpression, indexAssignment) : node.indexExpression.nodeType == "Literal" && decode(node.indexExpression, {
