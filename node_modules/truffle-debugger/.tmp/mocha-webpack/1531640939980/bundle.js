...
function read(storage, slot, offset = 0) {
  if (slot instanceof Array) {
    debug("slot %o, offset %o", slot, offset);
    slot = utils.keccak256(...slot);
