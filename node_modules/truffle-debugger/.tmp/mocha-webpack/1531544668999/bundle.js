...
describe("Decoding", function () {
   ...
   * Storage Tests
   */
  (0, _helpers.describeDecoding)("Storage Variables", fixtures, _selectors2.default.current.state.storage, contractName => {
...
`;
  ...
  (0, _helpers.describeDecoding)("Mapping Variables", mappingFixtures, _selectors2.default.current.state.storage, contractName => {
...
`;
   ...
   * Memory Tests
   */
  (0, _helpers.describeDecoding)("Memory Variables", fixtures, _selectors2.default.current.state.memory, contractName => {
    const separator = ";\n    ";
