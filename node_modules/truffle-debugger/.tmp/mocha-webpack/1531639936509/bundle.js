  ...
  switch (node.nodeType) {
    ...
    case "ContractDefinition":
      ...
      assignments = (0, _assign2.default)({}, ...(0, _entries2.default)(allocation.children).map(([id, storage]) => ({
        [id]: (0, _extends3.default)({}, currentAssignments[id], {
          storage
        })
      })));
